...
class WeeklyRankViewModel: BaseModel {
  lazy var weeklyRanks  = [[WeeklyModel]]()
}

extension WeeklyRankViewModel{
    func loadWeeklyRankData(_ rankType:RankType,_ completion:@escaping ()->Void) {
        let urlStr = "http://qf.56.com/activity/star/v1/rankAll.ios"
        ...
        NetworkTools.requestData(.get, urlStr: urlStr, paramsters: parameters) { (result) in
            //1.专成字典
